...
<body class="min-vh-100 d-flex">
  ...
  <div class="card w-75 p-3"
    ...
    <div class="d-flex justify-content-between bg-gray">
      ...
      <button class="btn btn-sm btn-primary"> <a href="tambah_guru" style="color:white; text-decoration:none">Tambah Data</a></button>
    </div>
    <hr>
      ...
      <tbody>
        ...
        foreach ($guru as $row):
          ...
          <tr>
            ...
            <!-- <td><img style="width:100px" src="<?= base_url('images/guru/' . $row->foto) ?>" alt=""></td> -->
            <td>
              <?= $row->nama_guru; ?>
            </td>
            <td>
            ...
            <td>
              <a href="<?php echo base_url('admin/edit_guru/') . $row->id ?>"
